...
export const deleteRequest = (url) => fetch(url, configObj("DELETE")).then(response => response.json())
...
export const patchRequest = (url, body) => fetch(url, configObjWithBody("PATCH", body)).then(response => response.json())